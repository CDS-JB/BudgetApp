<template>
    <div class="page">
        <div class="settingsForm shadow p-3 mb-5 bg-white rounded">
            ...
            <success-modal v-if="successModal.display" :options="successModal" @close="successModal.display = false"></success-modal>
        </div>
    </div>
</template>
...
export default {
    ...
    data(){
        return {
            ...
            redirectModal: {
                display: false,
                header: {text: 'Success'},
                body: {text: 'Successfully updated payment'},
    ...
    methods: {
        ...
        back(){
            this.$route.push('/payments/index');
        },
